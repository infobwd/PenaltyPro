        ...
        $out['tournaments'] = Response::time('tournaments', static function (): array {
            ...
            foreach ($rows as $t) {
                ...
                $config = [
                    ...
                    'sponsorDonationEnabled' => (bool) $t['sponsor_donation_enabled'],
                    'sponsorDonationUseExistingBank' => (bool) $t['sponsor_donation_use_existing'],
                    'sponsorDonationQrUrl' => drive_img($t['sponsor_donation_qr_url']),
                ...
                $list[] = [
                    ...
                    'type'   => $t['type'],
                    'status' => $t['status'],
                    'hostSchoolId' => $t['host_school_id'] ?? null,
